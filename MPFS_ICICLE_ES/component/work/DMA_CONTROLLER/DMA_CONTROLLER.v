//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Mon Oct 27 12:24:21 2025
...
wire   [7:0]  AXI4InitiatorDMA_IF_ARID;
...
wire   [7:0]  AXI4InitiatorDMA_IF_AWID;
...
wire   [7:0]  AXI4InitiatorDMA_IF_AWID_net_0;
...
wire   [7:0]  AXI4InitiatorDMA_IF_ARID_net_0;
...
assign AXI4InitiatorDMA_IF_AWID_net_0    = AXI4InitiatorDMA_IF_AWID;
assign DMA_AWID[7:0]                     = AXI4InitiatorDMA_IF_AWID_net_0;
...
assign AXI4InitiatorDMA_IF_ARID_net_0    = AXI4InitiatorDMA_IF_ARID;
assign DMA_ARID[7:0]                     = AXI4InitiatorDMA_IF_ARID_net_0;
...
// Component instances
//--------------------------------------------------------------------
//--------DMA_CONTROLLER_DMA_CONTROLLER_0_COREAXI4DMACONTROLLER   -   Actel:DirectCore:COREAXI4DMACONTROLLER:2.2.107
DMA_CONTROLLER_DMA_CONTROLLER_0_COREAXI4DMACONTROLLER #( 
        .AXI4_STREAM_IF       ( 0 ),
        .AXI_DMA_DWIDTH       ( 32 ),
        .DSCRPTR_0_INT_ASSOC  ( 0 ),
        .DSCRPTR_0_PRI_LVL    ( 0 ),
...
DMA_CONTROLLER_0(
        ...
        .TID          ( TID_const_net_0 ), // tied to 8'h00 from definition
