set_device \
    ...
    -pkg fcvg484
set_proj_dir \
    -path {D:\PION101\icicle-kit-reference-design\MPFS_ICICLE_ES}
set_impl_dir \
    -path {D:\PION101\icicle-kit-reference-design\MPFS_ICICLE_ES\designer\MPFS_ICICLE_KIT_BASE_DESIGN}
