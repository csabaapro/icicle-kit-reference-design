...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\PION101\icicle-kit-reference-design\MPFS_ICICLE_ES\synthesis\MPFS_ICICLE_KIT_BASE_DESIGN.vm"}
set_compile_info \
    -category {"Options"} \
    -name {"Limit the number of high fanout nets to display to"} \
    -value {"10"}
compile \
    -desdir {D:\PION101\icicle-kit-reference-design\MPFS_ICICLE_ES\designer\MPFS_ICICLE_KIT_BASE_DESIGN} \
    -design MPFS_ICICLE_KIT_BASE_DESIGN \
    -fam PolarFireSoC \
    -die PA5SOC250T_ES \
    -pkg fcvg484 \
    -partition_pdc_file {D:\PION101\icicle-kit-reference-design\MPFS_ICICLE_ES\designer\MPFS_ICICLE_KIT_BASE_DESIGN\MPFS_ICICLE_KIT_BASE_DESIGN.nmatinit.pdc} \
    -merge_pdc 0
